testthat::test_that("application foundation sources in a clean session", {
  ...
  sys.source(file.path(root, "R", "country_profile_data.R"), envir = env)
  sys.source(file.path(root, "R", "country_profile_helpers.R"), envir = env)
  sys.source(file.path(root, "R", "country_profile_visualizations.R"), envir = env)
  sys.source(file.path(root, "R", "mod_country_profile.R"), envir = env)
